 ...
 * @author oceans
 */
public class NuevaConsultaMedicaVgil extends javax.swing.JDialog {

    /**
     * Creates new form NuevaConsultaMedicaVgil
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nuevo Informe Médico ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevaConsultaMedicaVgil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NuevaConsultaMedicaVgil dialog = new NuevaConsultaMedicaVgil(new javax.swing.JFrame(), true);
